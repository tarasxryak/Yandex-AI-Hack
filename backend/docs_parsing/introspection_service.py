...
def fetch_introspection(
    ...
    if response.status_code in (401, 403):
        result = {
            ...
            "hint": 'retry with token or header, for example {"token":"..."} or {"headers":{"Authorization":"Bearer ..." }}',
    ...
    except Exception as exc:  # graphql-core raises several schema-specific errors.
        return {
            "success": False,
